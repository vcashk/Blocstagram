...
- (void) layoutSubviews {
    ...
    CGFloat imageHeight = self.mediaItem.image.size.height / 5.675;
    //the following is leading to a crash since its a division by 0 so using the magic number 5.675
